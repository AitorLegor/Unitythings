...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CardboardReticlePointer_Update_mDA81EA31248FBC24583F8E10E277647019954CFB (CardboardReticlePointer_t9A831A87CC4F4E8308410F73B91A763941ED0A3F* __this, const RuntimeMethod* method) 
{
	...
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* G_B13_0 = NULL;
	{
		...
		bool L_4;
		L_4 = Physics_Raycast_mE0FAFDE7AFE40061DA7518FA5C41CE6BB23DBC10(L_1, L_3, (&V_0), (20.0f), NULL);
		if (!L_4)
		{
			goto IL_00a8;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CardboardReticlePointer_UpdateDiameters_mC0F33DEAC1A47CDD75423242BEF5E7A4266F32C2 (CardboardReticlePointer_t9A831A87CC4F4E8308410F73B91A763941ED0A3F* __this, const RuntimeMethod* method) 
{
	...
	float V_3 = 0.0f;
	{
		...
		float L_1;
		L_1 = Mathf_Clamp_m154E404AF275A3B2EC99ECAA3879B4CB9F0606DC_inline(L_0, (0.449999988f), (20.0f), NULL);
...
IL_004b:
	{
		...
		float L_13;
		L_13 = Mathf_Lerp_mFB4910B358B986AFB22114ED90458E8341867479_inline(L_10, L_11, ((float)il2cpp_codegen_multiply(L_12, (8.0f))), NULL);
		...
		float L_17;
		L_17 = Mathf_Lerp_mFB4910B358B986AFB22114ED90458E8341867479_inline(L_14, L_15, ((float)il2cpp_codegen_multiply(L_16, (8.0f))), NULL);
...
{
	{
		...
		L_0 = LayerMask_op_Implicit_mDC9C22C4477684D460FCF25B1BFE6B54419FB922(((int32_t)256), NULL);
...
IL_0012:
	...
	}
	{
		...
		bool L_5;
		L_5 = Rect_op_Inequality_m4698BE8DFFC2C4F79B03116FC33FE1BE823A8945(L_3, L_4, NULL);
		if (!L_5)
		{
			goto IL_0079;
		}
...
IL_002f:
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(XRLoader_t9E03B2E5E25A68BDAD7018462DE0746D5B750779_il2cpp_TypeInfo_var);
		XRLoader_SetViewportOrientation_mEAE2B27FBAD563AF4AA34BF235792616915C5C7D(L_9, NULL);
	}
...
IL_004f:
	{
		...
		bool L_12;
		L_12 = Rect_op_Inequality_m4698BE8DFFC2C4F79B03116FC33FE1BE823A8945(L_10, L_11, NULL);
		if (!L_12)
		{
			goto IL_0074;
		}
	}
	{
		...
		L_14 = Screen_get_safeArea_m4FFA2CF15868DE7146265B14A4A95FC0561FE5AF(NULL);
		il2cpp_codegen_runtime_class_init_inline(XRLoader_t9E03B2E5E25A68BDAD7018462DE0746D5B750779_il2cpp_TypeInfo_var);
		XRLoader_RecalculateRectangles_m48F4E31CCDF5F0962AD6E431A9FA023F7F486200(L_14, NULL);
	}
